...
const Header = () => {
    const navigate = useNavigate() //! useNavigate react router-dom içerisinde bulunan yönlendirme yapan bir fonksiyondur
    ...
    const handleSubmit = (e) => {
        ...
        // result sayfasına yönlendir ve formdan gelen veriyi parametre olarak geç
    ...
    return (
        <header className="px-2 sm:px-4 py-[17px] flex justify-between items-center">
            ...
            <form onSubmit={handleSubmit} className="flex border border-gray-400 rounded-[20px] overflow-hidden">
                <input type="search" className="bg-[#0f0f0f] px-2 sm:px-5 py-1 sm:py-2 border border-transparent rounded-l-[20px]" />
